...
module AACT
  class Application < Rails::Application
    ...
    AACT_BACK_DATABASE_URL       = {
      encoding: 'utf8',
      adapter:  'postgresql',
      database: AACT_BACK_DATABASE_NAME,
      username: AACT_DB_SUPER_USERNAME,
      password: AACT_PASS,
      host:     AACT_HOST,
      port:     AACT_PORT
    }
    AACT_ADMIN_DATABASE_URL      = {
      encoding: 'utf8',
      adapter:  'postgresql',
      database: AACT_ADMIN_DATABASE_NAME,
      username: AACT_DB_SUPER_USERNAME,
      password: AACT_PASS,
      host:     AACT_HOST,
    }
    AACT_PUBLIC_DATABASE_URL     = {
      encoding: 'utf8',
      adapter:  'postgresql',
      database: AACT_PUBLIC_DATABASE_NAME,
      username: AACT_DB_SUPER_USERNAME,
      password: AACT_PASS,
      host:     AACT_PUBLIC_HOSTNAME,
    }
    AACT_ALT_PUBLIC_DATABASE_URL = {
      encoding: 'utf8',
      adapter:  'postgresql',
      database: AACT_ALT_PUBLIC_DATABASE_NAME,
      username: AACT_DB_SUPER_USERNAME,
      password: AACT_PASS,
      host:     AACT_PUBLIC_HOSTNAME,
    }
